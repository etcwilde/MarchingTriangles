...
sampling method of the function as time progresses.\evan{Provide some of the
maths from the paper} As we are not working with time, there is a far simpler
