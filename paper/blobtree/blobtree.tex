...
match the effects of the translation. \evan{I think that something about this
is wrong. It should only have an effect if the transform is a scale.
Translation and rotation don't do anything to the normals.}
...
\evan{There is an error in this calculation that must be fixed in the implicit
system as well. The normal will have a specific calculation for the various
transformations. Scale is the only one of the defined translate, rotate, and
scale where the inverse transform is required.}
